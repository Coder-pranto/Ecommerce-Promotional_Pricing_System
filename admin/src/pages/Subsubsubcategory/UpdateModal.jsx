...
const UpdateModal = ({
  ...
  const handleSubmit = (e) => {
    ...
    handleUpdateSubsubsubCategory(subsubsubcategory?._id, formData);
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              defaultValue={subsubsubcategory?.name}
          ...
          <div className="mb-4">
            ...
            <input
              ...
              id="description"
              name="description"
              defaultValue={subsubsubcategory.description}
              onChange={handleChange}
              className="w-full mt-1 p-2 border border-gray-300 rounded-md"
            />
          </div>
          <div className="mb-4 flex ">
            ...
            >
              ...
              <input
                ...
                id="status"
                name="status"
                defaultChecked={subsubsubcategory.status}
                onChange={handleChange}
                className="ml-2"
              />
            </label>
